    ...
    <main>
      ...
      <form noValidate onSubmit={handleSubmit(onSubmit)}>
        <div style={{ marginBottom: "16px" }}>
          <label style={{ display: "block", marginBottom: "4px" }}>Endereço de email</label>
          <div style={{ display: "flex", alignItems: "center", border: "1px solid grey", borderRadius: "4px", padding: "8px" }}>
        ...
        <div style={{ marginBottom: "16px" }}>
          <a href="#" style={{ color: "blue", textDecoration: "underline" }}>Esqueceu-se da palavra-passe?</a>
        </div>
        <button type="submit" style={{ marginBottom: "16px", padding: "10px 20px", borderRadius: "4px", background: "black", color: "white", border: "none", cursor: "pointer" }}>Iniciar sessão</button>
      </form>
      <div>
        <span>Não é membro? </span>
        <a href="" style={{ color: "blue", textDecoration: "underline" }}>Iniciar sessão</a>
      </div>
    </div>
        </div>
        {/**Trabalhar Aqui **/}
