export const ProdutosMaisVendidosdaSemana = () => {
  return (
    <div className="flex flex-col px-8 py-4 w-full m-auto max-w-[1400px]">
      <h2 className="m-auto py-8 font-bold text-4xl">Promoções da semana</h2>
      <div className="flex gap-8 m-6 p-6 relative">
        <div style={{ position: "relative", width: "1200px", height: "400px" }}>
          ...
          />
            ...
            <h3 className="text-cream-200 text-6xl">Roupas de Inverno</h3>
          </div>
